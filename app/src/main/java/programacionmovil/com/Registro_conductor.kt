...
class Registro_conductor : AppCompatActivity() {
    ...
    private lateinit var mEditTextPlaca: EditText
    private lateinit var mEditTextLinea: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mEditTextPlaca = findViewById(R.id.editTextPlaca)
        mEditTextLinea = findViewById(R.id.editTextLinea)
        ...
        nButtonRegister.setOnClickListener {
            ...
            placa = mEditTextPlaca.text.toString()
            linea = mEditTextLinea.text.toString()
    ...
    private fun validateInputs(): Boolean {
        ...
        if (!placa.matches(Regex("^[0-9]{3,4}[A-Za-z]{3}$"))) {
            Toast.makeText(this, "La placa debe tener de 3 a 4 números seguidos de 3 letras", Toast.LENGTH_SHORT).show()
            return false
        }
        if (linea.length < 3) {
            Toast.makeText(this, "La línea debe tener al menos 3 caracteres", Toast.LENGTH_SHORT).show()
            return false
        }
            ...
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    if (dataSnapshot.exists()) {
                        Toast.makeText(this@Registro_conductor, "El correo electrónico ya está registrado", Toast.LENGTH_SHORT).show()
                    } else {
                        registerUser()
                    }
                }
                ...
                override fun onCancelled(databaseError: DatabaseError) {
                    Toast.makeText(this@Registro_conductor, "Error de base de datos: ${databaseError.message}", Toast.LENGTH_SHORT).show()
                }
            })
    }
                    ...
                    mDatabase.child("Users").child(userId).setValue(userMap)
                        .addOnCompleteListener { dbTask ->
                            if (dbTask.isSuccessful) {
                                ...
                                startActivity(Intent(this@Registro_conductor, HomePageC::class.java))
                                finish()
                            } else {
